...
public class ClientThread implements Runnable{
    ...
    public void run() {
        try{
            ...
            Scanner in = new Scanner(inputtest);
            ...
            while(!socket.isClosed()){
                ...
                {
                	if(server.userExist(receivedPacket.getSender()))
                	{
                    	...
                    	this.clientOut.println("To " + receivedPacket.getReceiver() + " > " + receivedPacket.getMessage());
